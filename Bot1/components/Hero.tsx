    ...
    <section className="min-h-screen flex items-center justify-center pt-20 px-4 relative overflow-hidden">
      <div className="max-w-5xl mx-auto text-center z-10 animate-fade-in-up">
        ...
        <h1 className="text-5xl md:text-7xl font-black mb-6 tracking-tight leading-tight">
          Your Personal <br/>
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-accent to-pink-500">Tutor, Artist & Friend</span>
        </h1>
        
        <p className="text-xl md:text-2xl text-gray-300 font-medium mb-8 max-w-3xl mx-auto">
          Meet <span className="text-white font-bold">SanjayBot</span>. I help Anna University students ace exams, generate detailed diagrams, and stay motivated.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          <button 
            onClick={onStartChat}
            className="group flex items-center gap-2 bg-white text-bgDark hover:bg-gray-100 px-8 py-4 rounded-full font-bold text-lg shadow-xl shadow-white/10 transition-all transform hover:-translate-y-1"
          >

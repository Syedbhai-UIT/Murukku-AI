    ...
    <section id="interview" className="py-20 px-4 max-w-6xl mx-auto min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-1 space-y-2">
            ...
            <div className="mt-8 p-4 bg-gradient-to-br from-orange-500/10 to-yellow-500/10 border border-orange-500/20 rounded-xl">
                <h4 className="font-bold text-white mb-2 flex items-center gap-2">
                    <Cpu className="w-4 h-4 text-orange-400" /> AI Simulator
                </h4>
                <p className="text-xs text-gray-400 mb-4">
                    Practice with Murukku AI acting as a strict interviewer.
                </p>
                <button 
